...
function filterCategory(cat, event) {
    ...
    buttons.forEach(btn => {
        btn.className = "cat-btn bg-white/10 hover:bg-emerald-900 px-4 py-2 rounded-xl text-xs font-bold transition";
    });
    if (event && event.target) {
        event.target.className = "cat-btn bg-emerald-900 text-white px-4 py-2 rounded-xl text-xs font-bold transition";
    }
